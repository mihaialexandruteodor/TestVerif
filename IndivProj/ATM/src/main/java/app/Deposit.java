...
// app.Deposit.java
// Represents a deposit app.ATM transaction
      ...
      if (amount != CANCELED)
      {
         ...
         else // deposit envelope not received
         {
        	 screen.messageJLabel2.setText("\nYou did not insert an " +
               "envelope, so the app.ATM has canceled your transaction.");
         } // end else
      } // end if 
