...
public class BankDatabase
{
   ...
   // no-argument app.BankDatabase constructor initializes accounts
   public BankDatabase()
   {
   ...
   } // end no-argument app.BankDatabase constructor
   
   // retrieve app.Account object containing specified account number
   ...
   public boolean authenticateUser(int userPIN)
   {
      ...
      // if account exists, return result of app.Account method validatePIN
      if (userAccount != null)
   ...
   // return available balance of app.Account with specified account number
   public double getAvailableBalance(int userAccountNumber)
   {
      return getAccount(userAccountNumber).getAvailableBalance();
   } // end method getAvailableBalance

   // return total balance of app.Account with specified account number
   public double getTotalBalance(int userAccountNumber)
   {
      return getAccount(userAccountNumber).getTotalBalance();
   } // end method getTotalBalance

   // credit an amount to app.Account with specified account number
   public void credit(int userAccountNumber, double amount)
   {
      getAccount(userAccountNumber).credit(amount);
   } // end method credit

   // debit an amount from app.Account with specified account number
