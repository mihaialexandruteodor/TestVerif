package app;// app.Screen.java
// Represents the screen of the app.ATM
...
public void createmenu(){
	...
	messageJLabel3 = new JLabel("2 - app.Withdrawal");
	messageJLabel4 = new JLabel("3 - app.Deposit");
...
public void CreateDepositGUI(){
	...
	Inputfield2 = new JTextField(10);
	Inputfield2.setEditable(false);
	button1 = new JButton("app.Deposit");
	Exit = new JButton("Cancel");
	Mainframe.add(messageJLabel2);
	Mainframe.add(messageJLabel3);
	Mainframe.add(Inputfield2);
...
public void createAdminpage(){
	...
	messageJLabel2 = new JLabel("app.Account number:");
	...
	Mainframe.setLayout( new FlowLayout() );
	messageJLabel6 = new JLabel("Add app.Account: ");
	messageJLabel7 = new JLabel("User name: ");
	Mainframe.add(messageJLabel);
	messageJLabel8 = new JLabel("          app.Account number: ");
	Mainframe.add(messageJLabel2);
