...
public class ATM 
{
   ...
   private Screen screen; // app.ATM's screen
   private Keypad keypad; // app.ATM's keypad
   private CashDispenser cashDispenser; // app.ATM's cash dispenser
   private DepositSlot depositSlot; // app.ATM's deposit slot
   ...
   // no-argument app.ATM constructor initializes instance variables
   public ATM() 
   {
   ...
   } // end no-argument app.ATM constructor
   ...
   public void run()
   {
      // welcome and authenticate user; perform transactions
        ...
        //else
         ...
         //userAuthenticated = false; // reset before next app.ATM session
         //currentAccountNumber = 0; // reset before next app.ATM session
   ...
   {
      Transaction temp = null; // temporary app.Transaction variable
      screen.getContentPane().removeAll();
      screen.revalidate();
      
      // determine which type of app.Transaction to create
      
         if(type == 1) // create new app.BalanceInquiry transaction
            temp = new BalanceInquiry(
               currentAccountNumber, screen, bankDatabase);
                 else if(type == 2)// create new app.Withdrawal transaction
            temp = new Withdrawal(currentAccountNumber, screen, 
               bankDatabase, keypad, cashDispenser);
         else if(type == 3){ // create new app.Deposit transaction
