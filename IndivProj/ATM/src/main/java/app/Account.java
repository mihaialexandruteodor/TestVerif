...
public class Account 
{
   ...
   // app.Account constructor initializes attributes
      ...
      double theAvailableBalance, double theTotalBalance, int isadmin)
   {
      ...
      setAdmin(isadmin);
   } // end app.Account constructor

   // determines whether a user-specified PIN matches PIN in app.Account
